package com.edu.uceva.example.facultadservice.delivery.exception;
...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<Map<String, Object>> handleFacultadNoEncontrada(FacultadNoEncontradaException ex) {
        Map<String, Object> response = new HashMap<>();
